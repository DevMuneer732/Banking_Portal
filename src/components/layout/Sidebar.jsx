...
const navItems = [
    { name: 'My loans', icon: Banknote, active: true },
    ...
    return (
        <>
            ...
            <div
                ...
                md:relative md:translate-x-0 w-64 bg-white p-6 transition-transform duration-300 ease-in-out h-full z-30 shadow-xl md:shadow-none border-r border-gray-100`}
            >
                <div className="flex justify-between items-center mb-8 md:mb-12">
                    <h1 className="text-xl font-bold text-gray-800 tracking-wider">Banking Portal</h1>
                ...
                <nav>
                    {navItems.map(item => (
                        <a
                            key={item.name}
                            href="#"
                            className={`flex items-center space-x-3 p-3 rounded-lg transition duration-150 ${item.active ? 'bg-green-100 text-green-700 font-semibold' : 'text-gray-600 hover:bg-gray-50'}`}
                        >
                            <item.icon size={18} />
                            <span>{item.name}</span>
                        </a>
                ...
                {/* <div className="mt-8 p-4 rounded-lg bg-purple-700 text-white shadow-xl">
